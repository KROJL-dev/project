...
const Dialog = memo(({ ...props }: ComponentProps<typeof DialogPrimitive.Root>) => {
  return <DialogPrimitive.Root data-slot="dialog" {...props} />
})

const DialogTrigger = memo(({ ...props }: ComponentProps<typeof DialogPrimitive.Trigger>) => {
  return <DialogPrimitive.Trigger data-slot="dialog-trigger" {...props} />
})

const DialogPortal = memo(({ ...props }: ComponentProps<typeof DialogPrimitive.Portal>) => {
...
const DialogClose = memo(({ ...props }: ComponentProps<typeof DialogPrimitive.Close>) => {
...
const DialogFooter = memo(({ className, ...props }: ComponentProps<'div'>) => {
  return (
    <div
